...
import { DestType, PacketType } from "@reticulum/core/src/core/packet.js";
import { Persistor } from "@reticulum/core/src/storage/persistor.js";
import {
...
test("LXMRouter", async (t) => {
  ...
  await t.test(
    ...
    async () => {
      ...
      /** @type {import("@reticulum/core/src/core/packet.js").Packet|null} */
      let sentPacket = null;
