...
Node.js-only Reticulum interfaces and the interface registry, as a companion to the zero-dependency, browser-safe [`@reticulum/core`](../core/README.md) core.
...
```sh
npm install @reticulum/node
```

This depends on [`@reticulum/core`](https://www.npmjs.com/package/@reticulum/core) automatically.
