/**
 * @file storage.js
 * @description Platform-neutral persistence contract for reticulum-js
 *   (work doc #16).
 *
 * A single async key/value interface, backend-agnostic. The user supplies the
 * backend (file-on-disk for Node via `reticulum-js-node`, IndexedDB for the
 ...
 *  - `FileStorageAdapter` (`reticulum-js-node`) — one file per record on disk.
