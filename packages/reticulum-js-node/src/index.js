/**
 * @file index.js
 * @description reticulum-js-node — Node.js-only Reticulum interfaces and the
 ...
 *
 *   import { TCPClientInterface, getInterface } from "reticulum-js-node";
 *
 * The registry aggregates every built-in interface (including the
 * browser-safe ones from `reticulum-js`) so a Node process can discover
