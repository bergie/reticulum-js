 ...
 * (reticulum-js work doc #16): identity key + per-namespace record files on
...
import { Persistor, StorageNamespace } from "reticulum-js";
import { bytesEqual, fromHex, toHex } from "reticulum-js/src/utils/encoding.js";
