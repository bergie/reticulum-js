...
import { DestType, toHex } from "@reticulum/core";
 ...
 * @property {import("@reticulum/core").Identity|null} identity - Subscriber's
...
export class SubscriptionTable {
   ...
   *
   * @param {import("@reticulum/core").Identity} subscriberIdentity
