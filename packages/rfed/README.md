...
```js
import { RFedClient, RFedNode } from "@reticulum/rfed";
```

Requires `@reticulum/core` and `@reticulum/lxmf`. See the
[reticulum-js documentation](https://reticulum.js.org/) for guides and API
references.
